    ...
    >
      ...
      <div className="text-center flex w-full flex-row h-auto">
        <div className="flex flex-col mx-auto w-2/3 items-center ">
          <h1
            className="font-semibold text-7xl mb-4 mt-28 text-Verde text-center"
            style={{ textShadow: "2px 2px white" }}
          >
            Programa Kinerres
          </h1>
          <h2 className="font-normal text-2xl mb-2 text-black text-justify">
      ...
      <div className=" mx-auto items-center flex w-full justify-center ">
        <img src="/images/pulmon.png"  />
      </div>
      <div
        className="flex flex-col text-black mb-8 h-[35vh] items-center w-[90%] mx-auto "
       
      >
        <h1
          className="font-semibold text-5xl w-1/2 content-center justify-center flex text-Verde"
          style={{ textShadow: "2px 2px white" }}
        >
          ¿Quiénes somos?
        </h1>
      ...
      <div className="flex flex-row text-black p-4  mt-52 border-t-2 border-b-2 border-Verde"  id="tratamientos">
      ...
      >
        ...
        <div className="flex flex-row">
          ...
          <div className="w-1/2 p-3">
            <img
              src="/images/mapa.png"
              className="w-5/6 mx-auto flex border border-white"
            />
          </div>
        </div>
      </div>
